...
using TheSeries.AiService.Application.Instructions;
using TheSeries.AiService.Application.Skills;
using TheSeries.AiService.Application.Workspace;
using Xunit;
...
{
    private readonly string _root = Directory.CreateTempSubdirectory("theseries-scopes-").FullName;
