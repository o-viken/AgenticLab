  ...
  return (
    <div className={styles.app}>
      <header className={styles.header}>
        <a href="/" className={styles.brand} aria-label="Agentic AI home">
          <span className={styles.mark}><Waypoints size={24} aria-hidden="true" /></span>
          <span><span className={styles.overline}>THE SERIES</span><h1>Agentic AI</h1></span>
        </a>
        <div className={styles.headerActions}>
          ...
          <a className={`icon-button ${styles.repositoryLink}`} href="https://github.com/o-viken/the-series"
            target="_blank" rel="noopener noreferrer" title="View TheSeries on GitHub (opens in a new tab)"
            aria-label="View TheSeries on GitHub (opens in a new tab)">
